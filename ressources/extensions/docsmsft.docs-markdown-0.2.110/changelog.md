...
## 0.2.100 (October 1st, 2021)

- Cleanup script bugfixes.
- Update `Docs link by URL` command

## 0.2.98 (September 24th, 2021)

- Cleanup script bugfixes.
- Update link command to support microsoft.com embedded videos.

## 0.2.98 (September 20th, 2021)
